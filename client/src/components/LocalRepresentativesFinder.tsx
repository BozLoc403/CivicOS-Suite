...
const representatives: Representative[] = [
  {
    ...
    office: '55 St. Clair Ave West, Suite 308, Toronto, ON M4V 2Y7',
    nextTownHall: '2025-06-25 7:00 PM',
    responsiveness: 4,
    recentActivity: 'Tabled federal budget in Parliament',
    keyIssues: ['Economic Recovery', 'Healthcare', 'Climate Action']
  },
  {
    id: '2',
    name: 'Doug Ford',
    ...
    website: 'https://www.ontario.ca/page/premier-ontario',
    office: 'Legislative Building, Queen\'s Park, Toronto, ON M7A 1A1',
    responsiveness: 3,
    recentActivity: 'Announced new housing initiatives',
    keyIssues: ['Housing', 'Healthcare', 'Economic Development']
  },
  {
    id: '3',
    name: 'Olivia Chow',
    ...
    website: 'https://www.toronto.ca/city-government/accountability-operations-customer-service/office-of-the-mayor/',
    office: 'City Hall, 100 Queen St W, Toronto, ON M5H 2N2',
    nextTownHall: '2025-06-30 6:30 PM',
    responsiveness: 5,
    recentActivity: 'Launched affordable housing strategy',
    keyIssues: ['Housing Crisis', 'Transit', 'Climate Emergency']
  }
];
