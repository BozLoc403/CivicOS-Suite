...
export function DataStatusBanner({ 
  ...
  return (
    <Alert className={`border-yellow-200 bg-gradient-to-r from-yellow-50 to-amber-50 dark:border-yellow-800 dark:bg-gradient-to-r dark:from-yellow-950 dark:to-amber-950 backdrop-blur-sm shadow-lg ${className}`}>
...
export function LiveDataBanner({ 
  ...
  return (
    <Alert className={`border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 dark:border-green-800 dark:bg-gradient-to-r dark:from-green-950 dark:to-emerald-950 backdrop-blur-sm shadow-lg ${className}`}>
